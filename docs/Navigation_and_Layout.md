...
-   Dragging Box on **[Network
    Overview](http://cytoscape-working-copy.readthedocs.org/en/latest/Quick_Tour_of_Cytoscape.html#the-network-overview-window)** -
...
Networks](http://cytoscape-working-copy.readthedocs.org/en/latest/Nested_Networks.html#nested-networks)**
section.
