...
<tr> <th class="specalt ulcase">Label Autorotate</th>                  <td class="">Constrols the <i>Label Rotation</i> of each edge label. If this value is set to <i>true</i>, the edge label will be automatically rotated so that the label aligns with the edge. If it is set to <i>false</i>, the edge label will be positioned horizontally.</td> </tr>   
