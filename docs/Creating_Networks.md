...
**[Supported Network
Formats](http://cytoscape-working-copy.readthedocs.org/en/latest/Supported_Network_File_Formats.html#supported-network-file-formats)**
...
[Preferences](http://cytoscape-working-copy.readthedocs.org/en/latest/Cytoscape_Preferences.html#cytoscape-preferences)
...
Data](http://cytoscape-working-copy.readthedocs.org/en/latest/Node_and_Edge_Column_Data.html#node-and-edge-column-data)**
...
from External
Database](http://cytoscape-working-copy.readthedocs.org/en/latest/Creating_Networks.html?highlight=Web%20Service#what-is-a-web-service)**
for more detail.
